...
| 4 | Update Agent Files | Replace inline `## Output Format` template blocks in 10 agent files with reference instructions | in-progress | - | 3 | `.claude/PRPs/plans/extract-remaining-templates-phase-4.plan.md` |
