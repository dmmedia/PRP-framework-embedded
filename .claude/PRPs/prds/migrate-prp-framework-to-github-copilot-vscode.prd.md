...
| 5 | Hooks & plugins update | Update `plugins/prp-core` hooks to use configurable workdir and adapter env vars | in-progress | with 4 | 2 | .claude/PRPs/plans/migrate-prp-framework-to-github-copilot-vscode-phase-5.plan.md |
