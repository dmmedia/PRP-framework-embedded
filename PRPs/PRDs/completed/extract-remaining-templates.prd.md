...
| 3 | Extract Agent Templates | Create 12 template files from 10 agent files using `text-file-content-extractor-replacer` skill | complete | with 1 | - | `.claude/PRPs/plans/completed/extract-remaining-templates-phase-3.plan.md` |
| 4 | Update Agent Files | Replace inline `## Output Format` template blocks in 10 agent files with reference instructions | complete | - | 3 | `.claude/PRPs/plans/completed/extract-remaining-templates-phase-4.plan.md` |
