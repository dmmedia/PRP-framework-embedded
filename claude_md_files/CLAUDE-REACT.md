...
> ⚠️ **DEPRECATED:** This guide is for Claude workflows only. For GitHub Copilot/VS Code, see [copilot_md_files/COPILOT-REACT.md](../copilot_md_files/COPILOT-REACT.md)
