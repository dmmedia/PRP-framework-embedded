...
| 6 | Remaining agent guides | Migrate remaining agent guides from `claude_md_files/` to `copilot_md_files/` with deprecation headers in legacy files | complete | - | 3 | .claude/PRPs/plans/completed/migrate-prp-framework-to-github-copilot-vscode-phase-6.plan.md |
